    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{role_id: 2}">
			...
			<div class="mt-4" x-show="role_id == 2">
                ...
                <x-jet-input id="country" class="block mt-1 w-full" type="text" :value="old('country')" name="country" />
            </div>

            <div class="mt-4" x-show="role_id == 2">
                <x-jet-label for="phone_number" value="{{ __('Phone Number') }}" />
                <x-jet-input id="phone_number" class="block mt-1 w-full" type="text" :value="old('phone_number')" name="phone_number" />
            </div>
			...
			<div class="mt-4" x-show="role_id == 3">
                ...
                <x-jet-input id="company" class="block mt-1 w-full" type="text" :value="old('company')" name="company" />
            </div>
			
			<div class="mt-4" x-show="role_id == 3">
                <x-jet-label for="taxID" value="{{ __('TaxID') }}" />
                <x-jet-input id="taxID" class="block mt-1 w-full" type="text" :value="old('taxID')" name="taxID" />
            </div>
